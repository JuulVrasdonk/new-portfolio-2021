...
const clipboard = document.querySelector(".text-me");
const textItems = document.querySelectorAll(".wrapped");

export {link, cursorBorder, cursorIcon, cursor, workLink, cursorDot, aboutMeLink, magnetic, clipboard, textItems}